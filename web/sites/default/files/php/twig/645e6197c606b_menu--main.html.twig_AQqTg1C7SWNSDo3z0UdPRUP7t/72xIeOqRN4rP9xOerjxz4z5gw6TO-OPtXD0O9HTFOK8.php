...
/* themes/triune2019/templates/navigation/menu--main.html.twig */
class __TwigTemplate_b543310f28b6890680b400de1d247273 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 35
                    echo "      <ul";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "flexy-menu thin"], "method", false, false, true, 35), 35, $this->source), "html", null, true);
                    echo ">
    ";
                } else {
                    // line 37
  ...
  ";
    ...
    {
        return "themes/triune2019/templates/navigation/menu--main.html.twig";
    }
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% if items %}
    {% if menu_level == 0 %}
      <ul{{ attributes.addClass('flexy-menu thin') }}>
    {% else %}
      <ul>
    {% endif %}
    {% for item in items %}
  ...
  {% endif %}
{% endmacro %}
", "themes/triune2019/templates/navigation/menu--main.html.twig", "/app/web/themes/triune2019/templates/navigation/menu--main.html.twig");
    }
